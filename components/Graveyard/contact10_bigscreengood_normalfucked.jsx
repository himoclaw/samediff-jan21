...
const Contact = () => {
  ...
  return (
    <div className="relative bg-sd-black w-full h-screen overflow-y-auto overflow-x-hidden">
      ...
      <div className="relative flex justify-center items-center mt-16 mb-16 scale-90"> 
        ...
        <motion.div
            ...
            className="absolute bottom-[-15px] space-x-4 absolute flex flex-col lg:flex-row justify-center transition-opacity duration-300 z-30"
        ...
        {['artists', 'brands', 'jobs'].map((type, index) => (
          ...
          {['artists', 'brands', 'jobs'].map((type, index) => (
            ...
            <motion.a
              ...
              variants={itemVariants}
              style={{
                fontSize: '33px', // Adjust the scaling factor as needed
              }}
            >
              {`${type}@samedifference.tv`}
            </motion.a>
